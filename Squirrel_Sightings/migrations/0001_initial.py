# Generated by Django 2.2.7 on 2019-11-25 02:54
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Unique_Squirrel_Id', models.CharField(help_text="Squirrel's Unique ID", max_length=30)),
                ...
                ('Kuks', models.CharField(choices=[('true', 'True'), ('false', 'False')], help_text='Does it kuks?', max_length=20)),
                ('Quaas', models.CharField(choices=[('true', 'True'), ('false', 'False')], help_text='Does it quaas?', max_length=20)),
                ('Moans', models.CharField(choices=[('true', 'True'), ('false', 'False')], help_text='Does it moan?', max_length=20)),
                ('Tail_flags', models.CharField(choices=[('true', 'True'), ('false', 'False')], help_text='Does it flag its tail?', max_length=20)),
                ('Tail_twitches', models.CharField(choices=[('true', 'True'), ('false', 'False')], help_text='Does it twitch its tail?', max_length=20)),
